...
graph TD
    ...
    subgraph VMware[VMware Network - 172.16.10.0/24]
        ...
        subgraph HARBOR_VM[Harbor VM - 172.16.10.11]
            HB_Nginx[Nginx Proxy] --> Harbor[Harbor Registry]
            Harbor --> Redis
            Harbor --> Postgres[PostgreSQL]
        end
        ...
        subgraph N8N_VM[n8n VM - 172.16.10.12]
            N8N_Nginx[Nginx Proxy] --> n8nWorkflow[n8n Workflow]
        end
...
2. hosts 파일에 의해 요청이 각 VM으로 직접 전달:
   ...
   - n8n.local -> 172.16.10.12:5678 (n8n Workflow)
   등...
...
| n8n Workflow | https://n8n.local | 워크플로우 자동화 |
